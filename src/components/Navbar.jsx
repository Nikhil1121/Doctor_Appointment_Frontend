      ...
      <div className="flex items-center gap-4">
        ...
        <div className={`${showMenu ? "fixed inset-0" : "h-0 w-0 overflow-hidden"} md:hidden z-20 bg-white transition-all duration-300`}>
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 text-lg font-medium">
            <NavLink onClick={() => setShowMenu(false)} to="/" className="w-full text-center"><p className="px-4 py-3 hover:bg-gray-50 rounded">Home</p></NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/doctors" className="w-full text-center"><p className="px-4 py-3 hover:bg-gray-50 rounded">All Doctors</p></NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/about" className="w-full text-center"><p className="px-4 py-3 hover:bg-gray-50 rounded">About</p></NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/contact" className="w-full text-center"><p className="px-4 py-3 hover:bg-gray-50 rounded">Contact</p></NavLink>
            {!token && (
            ...
            {token && (
              <>
                <NavLink onClick={() => setShowMenu(false)} to="/my-profile" className="w-full text-center"><p className="px-4 py-3 hover:bg-gray-50 rounded">My Profile</p></NavLink>
                <NavLink onClick={() => setShowMenu(false)} to="/my-appointments" className="w-full text-center"><p className="px-4 py-3 hover:bg-gray-50 rounded">My Appointments</p></NavLink>
